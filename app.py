...
if __name__ == "__main__":
    ...
    csv_path = "/home/mike_mitch/PLP Project/AI_for_Software-Engineering/CO-Emissions-Estimator/country_emissions.csv"
    try:
        ...
        st.error("Dataset file not found for download")
